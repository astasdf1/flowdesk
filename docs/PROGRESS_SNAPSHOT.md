...
10. Durable cross-process confirmation consumption remains a user-ready installer hardening gap until CLI/profile wiring can persist pending and consumed confirmation state across process restarts.
