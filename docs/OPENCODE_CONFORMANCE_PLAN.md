...
OpenCode 1.14.40 local isolated PoC completed on 2026-05-15, with an FDS-1 runtime-closed schema conversion probe added on 2026-05-18 and Release 1 packaging/bootstrap smoke evidence added on 2026-05-19. The evidence supports Release 1 as a General-Use MVP with chat-routed command-backed workflows, tested hook-harness containment surfaces, FDS-1 compatibility through FlowDesk runtime-closed validation, local package/bin smoke, and non-dispatch command-backed production registration. Real OpenCode dispatch, hard managed chat control, sufficient event telemetry, broad hook containment, provider/API/model managed fallback, actual lane launch, and trusted real-provider runtime echo remain gated. See `conformance/2026-05-15-opencode-1.14.40-poc.md`, `conformance/2026-05-18-fds1-schema-conversion-probe.md`, and `conformance/2026-05-19-release1-packaging-bootstrap-smoke.md`.
