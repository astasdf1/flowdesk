...
OpenCode 1.14.40 local isolated PoC completed on 2026-05-15, with an FDS-1 runtime-closed schema conversion probe added on 2026-05-18. The evidence supports Release 1 as a General-Use MVP with chat-routed command-backed workflows, tested hook-harness containment surfaces, and FDS-1 compatibility through FlowDesk runtime-closed validation. Real OpenCode dispatch, hard managed chat control, sufficient event telemetry, production OpenCode tool registration, broad hook containment, provider/API/model managed fallback, and trusted real-provider runtime echo remain gated. See `conformance/2026-05-15-opencode-1.14.40-poc.md` and `conformance/2026-05-18-fds1-schema-conversion-probe.md`.
