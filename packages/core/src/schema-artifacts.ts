...
const requiredFields: Record<string, readonly string[]> = {
  ...
  "flowdesk.optimizer_proposal_score.v1": ["schema_version", "score_id", "workflow_id", "proposal_id", "candidate_ref", "hard_filter_state", "blocked_labels", "score_dimensions", "advisory_score", "advisory_only", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled"],
  "flowdesk.normalized_score_aggregation.v1": ["schema_version", "aggregation_id", "workflow_id", "source_score_id", "dimension_scores", "normalized_score", "total_weight", "strict_minimum_breached", "hard_filter_state", "aggregation_reason_ref", "aggregated_at", "advisory_only", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.score_reuse_threshold_gate.v1": ["schema_version", "gate_id", "workflow_id", "previous_score_ref", "previous_context_hash", "current_context_hash", "score_age_seconds", "max_age_threshold_seconds", "min_score_threshold", "previous_advisory_score", "context_match", "within_age_threshold", "above_min_score", "gate_decision", "reason_refs", "evaluated_at", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.fanout_cadence_gate.v1": ["schema_version", "gate_id", "workflow_id", "requested_lane_count", "max_concurrent_lanes", "active_lane_count", "cadence_window_seconds", "cooldown_seconds", "seconds_since_last_burst", "risk_labels", "dependency_refs", "reason_refs", "gate_decision", "evaluated_at", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.local_ledger_snapshot.v1": ["schema_version", "snapshot_id", "workflow_id", "captured_at", "entry_count", "staleness_seconds", "safe_next_actions", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.score_reference_pack.v1": ["schema_version", "reference_pack_id", "workflow_id", "task_signature_ref", "score_refs", "snapshot_refs", "gate_decision_refs", "captured_at", "safe_next_actions", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.workflow_signature_index_entry.v1": ["schema_version", "entry_id", "workflow_id", "task_signature_ref", "created_at", "advisory_only", "non_authorizing", "safe_next_actions", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.oi_session_summary.v1": ["schema_version", "summary_id", "session_ref", "workflow_id", "proposals_scored", "reuse_gates_checked", "fanout_gates_evaluated", "ledger_entries_total", "advisory_health_label", "captured_at", "safe_next_actions", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.specialist_workflow_eligibility.v1": ["schema_version", "eligibility_id", "workflow_id", "task_signature_ref", "eligibility_decision", "specialist_category", "confidence_score", "reason_refs", "blocking_labels", "evaluated_at", "advisory_only", "non_authorizing", "safe_next_actions", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "routing_authority_enabled", "model_selection_authority_enabled"],
  "flowdesk.specialist_source_register.v1": ["schema_version", "register_id", "workflow_id", "source_domain", "source_entries", "curation_policy_ref", "approved_by_ref", "approved_at", "advisory_only", "non_authorizing", "safe_next_actions", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "routing_authority_enabled", "model_selection_authority_enabled"],
  "flowdesk.specialist_finding.v1": ["schema_version", "finding_id", "workflow_id", "task_ref", "specialist_category", "source_register_ref", "reference_pack_refs", "finding_summary_ref", "finding_status", "confidence_score", "uncertainty_labels", "generated_at", "human_review_required", "final_professional_decision", "product_decision_authority_enabled", "advisory_only", "non_authorizing", "safe_next_actions", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "routing_authority_enabled", "model_selection_authority_enabled"],
  "flowdesk.human_review_boundary.v1": ["schema_version", "boundary_id", "workflow_id", "finding_ref", "human_review_required", "signoff_status", "product_decision_use_allowed_without_human_signoff", "final_professional_decision", "professional_decision_authority_enabled", "advisory_only", "non_authorizing", "safe_next_actions", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "routing_authority_enabled", "model_selection_authority_enabled"],
  "flowdesk.mcp_connector_advisory.v1": ["schema_version", "advisory_id", "connector_id", "connector_kind", "connector_state", "state_reason_refs", "observed_at", "safe_next_actions", "advisory_only", "non_authorizing", "connector_execution_authority_enabled", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  ...
  "flowdesk.github_connector_production_publish_flag.v1": ["schema_version", "state", "created_at", "advisory_only", "non_authorizing", "remote_write_authority_enabled", "dispatch_authority_enabled", "write_authority_enabled"],
  ...
  "flowdesk.surplus_usage_gate.v1": ["schema_version", "gate_id", "workflow_id", "snapshot_ref", "snapshot_hash", "snapshot_captured_at", "evaluated_at", "snapshot_age_seconds", "max_snapshot_age_seconds", "provider_family", "bucket_label", "remaining_percent", "surplus_threshold_percent", "alert_level", "snapshot_fresh", "alert_level_safe", "surplus_sufficient", "gate_verdict", "blocked_labels", "reason_refs", "release_gate", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.r3_admission_decision.v1": ["schema_version", "decision_id", "workflow_id", "workflow_signature_ref", "attempt_id", "surplus_gate_ref", "surplus_gate_verdict", "reuse_gate_ref", "reuse_gate_decision", "cadence_gate_ref", "cadence_gate_decision", "execution_mode", "combined_snapshot_hash", "decided_at", "config_ref", "release_gate", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.r3_fanout_reservation.v1": ["schema_version", "reservation_id", "attempt_id", "workflow_id", "admission_decision_ref", "provider_family", "bucket_label", "estimated_tokens_reserved", "daily_hard_cap_tokens", "tokens_already_reserved_today", "daily_cap_check", "daily_cap_blocked_labels", "reserved_at", "expires_at", "cadence_window_seconds", "status", "fsync_required", "release_gate", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.advisory_variant_result.v1": ["schema_version", "variant_result_id", "admission_decision_ref", "reservation_ref", "workflow_id", "attempt_id", "workflow_signature_ref", "execution_purpose", "variant_id", "variant_index", "variant_total", "model_ref", "provider_family", "proposal_ref", "outcome_class", "outcome_reason_refs", "bounded_summary_label", "duration_ms", "provider_token_usage_estimate", "started_at", "completed_at", "not_consumable_as_primary_task_result", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled"],
  "flowdesk.model_capability_profile.v1": ["schema_version", "profile_id", "model_ref", "provider_qualified_model_id", "scored_at", "category_fitness", "complexity_handling_score", "authority_sensitivity_score", "evidence_refs", "freshness_ttl_seconds", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.block_selection_criteria.v1": ["schema_version", "criteria_id", "block_scoring_ref", "derived_at", "min_category_fitness_required", "min_complexity_handling_required", "min_authority_score_required", "allows_multi_model", "requires_multi_model", "source_block_id", "source_block_score", "source_category", "source_complexity", "source_authority_sensitivity", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.model_selection_result.v1": ["schema_version", "selection_id", "block_scoring_ref", "criteria_ref", "evaluated_at", "evaluated_model_profile_refs", "eligible_model_refs", "selected_model_ref", "selected_provider_qualified_model_id", "selection_reason", "ineligible_model_entries", "quota_snapshot_ref", "selection_failed", "escalation_required", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.ledger_retention_policy.v1": ["schema_version", "max_score_age_days", "max_ledger_entries_per_signature", "prune_mode", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.compaction_evidence.v1": ["schema_version", "compactionId", "compactionTriggeredAt", "compactionCompletedAt", "filesProcessed", "ageFilterApplied", "merkleRootBefore", "merkleRootAfter"],
  "flowdesk.routing_influence_policy.v1": ["schema_version", "enabled", "min_sample_threshold", "tie_quota_delta_percent", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.routing_advisory_evaluation.v1": ["schema_version", "evaluation_id", "signature_ref", "evaluated_at", "model_summaries", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.ledger_compaction_snapshot.v1": ["schema_version", "compaction_id", "policy_ref", "original_entry_count", "retained_entry_count", "pruned_entry_count", "pruned_ttl_count", "pruned_cap_count", "pending_gate_promotion_preserved_count", "byte_size_pre", "byte_size_post", "trigger_reason", "ledger_hash_before", "ledger_hash_after", "compacted_at", "advisory_only", "non_authorizing", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.block_decomposition.v1": ["schema_version", "decomposition_id", "parent_block_id", "parent_block_scoring_ref", "trigger_score", "trigger_condition_met", "trigger_dimensions_met", "sub_blocks", "current_depth", "max_depth", "coverage_review_quorum_required", "coverage_verdict_refs", "structural_coverage_pass", "status", "decomposition_model_selection_ref", "non_inheriting_parent_authority", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.block_hierarchy.v1": ["schema_version", "hierarchy_id", "root_block_id", "workflow_id", "revision_id", "nodes", "total_nodes", "max_depth", "status", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.block_score_reconciliation.v1": ["schema_version", "reconciliation_id", "decomposition_ref", "sub_block_id", "fresh_scoring_ref", "diverged_dimensions", "dimension_deltas", "max_divergence", "authority_sensitivity_increased", "action_required", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  "flowdesk.block_decomposition_failure.v1": ["schema_version", "failure_id", "decomposition_attempt_id", "parent_block_scoring_ref", "failure_reason", "failed_at", "retry_allowed", "advisory_only", "non_authorizing", "release_gate", "dispatch_authority_enabled", "approval_authority_enabled", "provider_authority_enabled", "runtime_authority_enabled", "external_write_authority_enabled", "remote_write_authority_enabled", "fallback_authority_enabled", "lane_launch_authority_enabled", "write_authority_enabled", "hard_chat_authority_enabled", "model_selection_authority_enabled", "ranking_authority_enabled"],
  ...
  "flowdesk.omnigent_provider_usage_input.v1": ["schema_version", "source", "providers"],
...
const optionalFields: Record<string, readonly string[]> = {
  ...
  "flowdesk.surplus_usage_gate.v1": ["compaction_control"],
  ...
  "flowdesk.workflow_plan_proposal.v1": ["created_at", "source", "source_ref", "variant", "redacted_intake_refs", "taxonomy_axes", "taxonomy_refs", "step_summary", "write_summary", "verification_summary", "rollback_summary", "cost_estimate_ref", "latency_estimate_ref", "provenance_refs", "safe_next_actions"],
  ...
  "flowdesk.optimizer_proposal_score.v1": [],
  "flowdesk.normalized_score_aggregation.v1": [],
  "flowdesk.score_reuse_threshold_gate.v1": [],
  "flowdesk.fanout_cadence_gate.v1": [],
  "flowdesk.local_ledger_snapshot.v1": ["oldest_entry_ref", "newest_entry_ref", "content_hash_summary"],
  "flowdesk.score_reference_pack.v1": [],
  "flowdesk.workflow_signature_index_entry.v1": ["reference_pack_ref", "category_fit_snapshot_ref", "last_scored_at"],
  "flowdesk.oi_session_summary.v1": [],
  "flowdesk.specialist_workflow_eligibility.v1": [],
  "flowdesk.specialist_source_register.v1": [],
  "flowdesk.specialist_finding.v1": [],
  "flowdesk.human_review_boundary.v1": ["human_reviewer_ref", "human_signoff_ref", "signoff_recorded_at"],
  "flowdesk.mcp_connector_advisory.v1": [],
  ...
  "flowdesk.github_connector_production_publish_flag.v1": ["consumes_surplus_usage_gate_ref", "consumes_minimization_policy_ref", "consumes_guard_approval_ref"],
  "flowdesk.r3_admission_decision.v1": ["skip_reason", "reservation_id"],
  "flowdesk.r3_fanout_reservation.v1": ["consumed_at", "released_at", "expired_at"],
  "flowdesk.advisory_variant_result.v1": ["normalized_score_ref"],
  "flowdesk.model_capability_profile.v1": [],
  "flowdesk.block_selection_criteria.v1": [],
  "flowdesk.model_selection_result.v1": [],
  "flowdesk.ledger_retention_policy.v1": [],
  "flowdesk.compaction_evidence.v1": ["failedReason", "records_preserved_due_to_pending_gate_promotion", "lock_path", "records_quarantined", "compaction_run_id"],
  "flowdesk.routing_influence_policy.v1": [],
  "flowdesk.routing_advisory_evaluation.v1": [],
  "flowdesk.ledger_compaction_snapshot.v1": ["workflow_id"],
  "flowdesk.block_decomposition.v1": [],
  "flowdesk.block_hierarchy.v1": ["previous_revision_ref", "node_count_warning", "allow_deep_decomposition"],
  "flowdesk.block_score_reconciliation.v1": [],
  ...
  "flowdesk.omnigent_provider_usage_input.v1": ["captured_at", "observed_at", "claude", "openai", "gemini"],
...
function propertyType(fieldName: string): Release1JsonSchemaPropertyType {
  ...
  if (fieldName.startsWith("is_") || fieldName.startsWith("allow_") || fieldName.startsWith("requires_") || fieldName.endsWith("_eligible") || fieldName.endsWith("_enabled") || fieldName.endsWith("_authorized") || fieldName.endsWith("_bypassed") || fieldName.endsWith("_applied") || fieldName.endsWith("_attempted") || fieldName.endsWith("_required") || fieldName.endsWith("_allowed") || fieldName.endsWith("_confirmed") || fieldName.endsWith("_inferred") || fieldName.endsWith("_ok") || fieldName.endsWith("_only") || fieldName.endsWith("_made") || fieldName.endsWith("_planned") || fieldName === "non_authorizing" || fieldName === "final_professional_decision" || fieldName === "product_decision_use_allowed_without_human_signoff" || fieldName === "ok" || fieldName === "refresh" || fieldName === "available" || fieldName === "enabled" || fieldName === "persist_report" || fieldName === "providerCall" || fieldName === "actualLaneLaunch" || fieldName === "runtimeExecution" || fieldName === "cache_usable_for_assignment" || fieldName === "unrelated_profile_mutation" || fieldName === "omitted_legacy_runtime_imports") return "boolean";
  if (fieldName.endsWith("_count") || fieldName.endsWith("_days") || fieldName.endsWith("_percent") || fieldName.startsWith("byte_size_") || fieldName === "priority" || fieldName === "freshness_ttl" || fieldName === "byte_count" || fieldName === "file_count" || fieldName === "max_concurrent_lanes" || fieldName === "cadence_window_seconds" || fieldName === "cooldown_seconds" || fieldName === "seconds_since_last_burst" || fieldName === "proposals_scored" || fieldName === "reuse_gates_checked" || fieldName === "fanout_gates_evaluated" || fieldName === "ledger_entries_total" || fieldName === "confidence_score" || fieldName === "max_results" || fieldName === "records_preserved_due_to_pending_gate_promotion" || fieldName === "records_quarantined") return "number";
  if (fieldName.endsWith("s") || fieldName.endsWith("_refs") || fieldName.endsWith("_hashes") || fieldName === "source_entries" || fieldName === "safe_next_actions" || fieldName === "lane_refs" || fieldName === "uncertainty_flags" || fieldName === "include_sections" || fieldName === "diagnostic_observations") return "array";
  if (["error", "provider_health_summary", "guard_precheck", "blocker", "blocker_summary", "retention", "usage_policy", "provider_health_policy", "hook_policy", "taxonomy", "model_requirements", "retention_override", "usage_policy_override", "provider_health_policy_override", "hook_policy_override", "promotion_readiness", "managed_dispatch_boundary_input", "managed_dispatch_request", "managed_dispatch_manifest", "managed_dispatch_reloaded_evidence", "claude", "openai", "gemini"].includes(fieldName)) return "object";
  return "string";
}
...
function propertyDescription(fieldName: string): string {
  switch (fieldName) {
    ...
    case "recorded_parent_provider_qualified_model_id": return "Model of parent/main session at task launch time, used by wake consumer to match model";
