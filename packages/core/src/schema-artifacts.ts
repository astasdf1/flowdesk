...
function propertyType(fieldName: string): Release1JsonSchemaPropertyType {
  ...
  if (fieldName.endsWith("_count") || fieldName === "priority" || fieldName === "freshness_ttl" || fieldName === "byte_count" || fieldName === "file_count" || fieldName === "remaining_percent" || fieldName === "max_concurrent_lanes" || fieldName === "cadence_window_seconds" || fieldName === "cooldown_seconds" || fieldName === "seconds_since_last_burst" || fieldName === "proposals_scored" || fieldName === "reuse_gates_checked" || fieldName === "fanout_gates_evaluated" || fieldName === "ledger_entries_total" || fieldName === "confidence_score" || fieldName === "idempotency_window_days" || fieldName === "max_results_per_query" || fieldName === "query_rate_limit_per_hour" || fieldName === "cache_ttl_seconds" || fieldName === "max_results") return "number";
