...
function propertyType(fieldName: string): Release1JsonSchemaPropertyType {
  ...
  if (fieldName.endsWith("_count") || fieldName === "priority" || fieldName === "freshness_ttl" || fieldName === "byte_count" || fieldName === "file_count" || fieldName === "remaining_percent" || fieldName === "max_concurrent_lanes" || fieldName === "cadence_window_seconds" || fieldName === "cooldown_seconds" || fieldName === "seconds_since_last_burst") return "number";
