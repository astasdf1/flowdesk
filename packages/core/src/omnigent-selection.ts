...
export const FLOWDESK_OMNIGENT_DEFAULT_REGISTRY_V1: Record<FlowDeskOmnigentTaskRoleV1, readonly RegistryEntry[]> = {
	policy_security: [
		...
		{ agent: "policy-security-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_policy_security_prefers_deep_reasoning", confidence: "medium" },
		...
		{ agent: "policy-security-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_policy_security_prefers_deep_reasoning", confidence: "high" },
		{ agent: "policy-security-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_policy_security_prefers_deep_reasoning", confidence: "high" },
		{ agent: "policy-security-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_policy_security_prefers_deep_reasoning", confidence: "medium" },
	],
	architecture: [
		...
		{ agent: "architecture-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_architecture_prefers_frontier_reasoning", confidence: "high" },
		{ agent: "architecture-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_architecture_prefers_frontier_reasoning", confidence: "high" },
		{ agent: "architecture-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_architecture_prefers_frontier_reasoning", confidence: "medium" },
		...
		{ agent: "architecture-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_architecture_prefers_frontier_reasoning", confidence: "medium" },
	],
	implementation: [
		...
		{ agent: "implementation-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_implementation_prefers_coding_harness", confidence: "high" },
		{ agent: "implementation-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_implementation_prefers_coding_harness", confidence: "high" },
		{ agent: "implementation-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_implementation_prefers_coding_harness", confidence: "medium" },
		...
		{ agent: "implementation-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_implementation_prefers_coding_harness", confidence: "medium" },
	],
	verification: [
		...
		{ agent: "verification-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_verification_prefers_cost_controlled_model", confidence: "high" },
		{ agent: "verification-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_verification_prefers_cost_controlled_model", confidence: "high" },
		{ agent: "verification-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_verification_prefers_cost_controlled_model", confidence: "medium" },
		...
		{ agent: "verification-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_verification_prefers_cost_controlled_model", confidence: "medium" },
	...
	research: [
		...
		{ agent: "research-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_research_prefers_sonnet_context", confidence: "medium" },
		...
		{ agent: "research-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_research_prefers_sonnet_context", confidence: "high" },
		{ agent: "research-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_research_prefers_sonnet_context", confidence: "high" },
		{ agent: "research-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_research_prefers_sonnet_context", confidence: "medium" },
	],
	general: [
		...
		{ agent: "general-agent", harness: "codex", model: "openai/gpt-5.6", model_tier: "frontier", provider_family: "openai", reason_code: "role_general_prefers_balanced_model", confidence: "high" },
		{ agent: "general-agent", harness: "codex", model: "openai/gpt-5.6-terra", model_tier: "normal", provider_family: "openai", reason_code: "role_general_prefers_balanced_model", confidence: "high" },
		{ agent: "general-agent", harness: "codex", model: "openai/gpt-5.6-luna", model_tier: "fast", provider_family: "openai", reason_code: "role_general_prefers_balanced_model", confidence: "medium" },
		...
		{ agent: "general-agent", harness: "claude-native", model: "claude-fable-5", provider_family: "claude", reason_code: "role_general_prefers_balanced_model", confidence: "medium" },
	],
	gemini_experimental: [
		{
			agent: "gemini-agent",
