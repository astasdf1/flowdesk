...
export const FLOWDESK_SESSION_EVIDENCE_CLASSES = [
	...
	"sdk_adapter_capability_smoke",
	"coordinator_retry_decision",
	"oi_session_summary",
	"block_decomposition",
	"block_decomposition_failure",
...
const evidenceClassSegment: Record<FlowDeskSessionEvidenceClass, string> = {
	...
	provider_health_snapshot: "provider-health-snapshot",
	...
	session_finalization_evidence: "session-finalization-evidence",
	...
	sdk_adapter_capability_smoke: "sdk-adapter-capability-smoke",
	coordinator_retry_decision: "coordinator-retry-decision",
	oi_session_summary: "oi-session-summary",
	block_decomposition: "block-decomposition",
	block_decomposition_failure: "block-decomposition-failure",
