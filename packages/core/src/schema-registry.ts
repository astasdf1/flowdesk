...
export const RELEASE_1_SCHEMA_REGISTRY: Release1SchemaMetadata[] = [
  ...
  artifactEntry("flowdesk.specialist_source_register.v1", "specialist-source-register", "FlowDeskSpecialistSourceRegisterV1", "later_release"),
  artifactEntry("flowdesk.specialist_finding.v1", "specialist-finding", "FlowDeskSpecialistFindingV1", "later_release"),
  artifactEntry("flowdesk.human_review_boundary.v1", "human-review-boundary", "FlowDeskHumanReviewBoundaryV1", "later_release"),
